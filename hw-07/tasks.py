...
for key in keys:
    ...
    print("Вставлено:", key)
    print(f"AVL-Дерево:{root}")
    # Task 1
    max_node_value = max_value_node(root).key
    print(f"Here is the max node value: {max_node_value}")
    # Task 2
    min_node_value = min_value_node(root).key
    print(f"Here is the min node value: {min_node_value}")
    # Task 3
    sum_node_values = sum_value_node(root)
    print(f"Here is the sum of node values: {sum_node_values}")
